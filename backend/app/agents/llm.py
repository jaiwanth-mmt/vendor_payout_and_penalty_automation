    ...
    *,
    ...
    return "\n".join(
        [
            ...
            "Primary evidence is source text: comments → Remarks → Sub Category (row context only).",
            "Tracking/vendor/fare context may appear via tools; treat it as supporting context, not a substitute for comments/Remarks.",
            ...
            "Tracking/vendor/fare may appear as supporting context; never use them alone to approve a penalty.",
